...
if not video_path:
    print("Path video kosong.")
    sys.exit(1)
if not os.path.exists(video_path):
    print(f"Video tidak ditemukan di: {video_path}")
    sys.exit(1)
...
print("\nVideo aktif. Tunjukkan tangan untuk mulai merekam gesture...")
...
while cap.isOpened():
    ...
    cv2.imshow('BISINDO Video Recognition', frame)
